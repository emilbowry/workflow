...
const customRules: ReadonlyArray<TLintMeta> = [
    maxTotalDepth,
    noNestedFunction,
    restrictReturnCount,
    enforceRecordType,
...
const RULE_INTERACTIONS: string =
    ...
    " --fix re-indents;" +
    " depth exceeds 3.\n" +
    "    Solution: use try-dispatch" +
    " for 4+ branches.\n" +
    "  </interaction>\n" +
    "  <interaction>\n" +
    "    restrict-return-count +" +
    " if-chains → multiple returns.\n" +
    "    Solution: ternary (2-3" +
    " branches) or try-dispatch" +
    " (4+).\n" +
    "  </interaction>\n" +
    "  <interaction>\n" +
    "    consistent-type-assertions:" +
    "never + Record dispatch" +
    " → cannot cast.\n" +
    "    Solution: switch dispatch" +
    " with type narrowing in each" +
    " case.\n" +
    "  </interaction>\n" +
    "  <interaction>\n" +
    "    functional/no-let +" +
    " switch dispatch → tension.\n" +
    "    Known: switch+let is the" +
    " only pattern satisfying\n" +
    "    return-count + depth +" +
    ...
    " + indent → permanent" +
    " incompatibility\n" +
    "    on deep ternaries. No" +
    " prettier config fixes this.\n" +
